...
const SingleEmployee = ({ employees, match, edit, deleteEmployee, update, user, team, role}) => {
  ...
  return (
    ...
    <div>{role === "manager" ? <div className="manager"><h4>Admin Actions</h4><div className="manager2"><Link className="managerButton" to="/new"><button style={button}>Create Employee</button></Link></div></div>: ""}
         {role === "manager" ? <div className="manager"><h4>Manager Actions</h4><div className="manager2"><button style={button} onClick={(event) => edit(employee)}>Modify Existing</button><button style={buttonRed} onClick={toggleVisibility}>Terminate Existing</button></div></div> : ""}
         ...
         <div className="manager"><h4>Standard Actions</h4><div className="manager"><Link className="linkButton" to="/">
